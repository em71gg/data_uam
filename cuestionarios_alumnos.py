...
input_file = "datos_finales_para_cuestionarios.csv"
df = pd.read_csv(input_file, sep=";", header=0, encoding="utf-8")
row = pd.read_csv(input_file, sep=";", header=0, encoding="utf-8")
...
for nombre_columna_cuestionario in payload_cuestionario.keys():
# nombre_columna_cuestionario = "CRITCEM4" 
    if nombre_columna_cuestionario in df.columns:
        continue
    else:
        print("La columna {} NO existe.".format(nombre_columna_cuestionario))
    # try:
